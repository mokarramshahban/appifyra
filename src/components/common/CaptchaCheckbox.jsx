  ...
  return (
    <div 
      ...
      style={{
        ...
        border: `1px solid ${isVerified ? 'rgba(74, 222, 128, 0.4)' : 'var(--card-border)'}`,
        borderRadius: '12px',
    ...
    >
      <div className="d-flex align-items-center gap-3">
        ...
        >
          {isVerifying ? (
            <i className="fas fa-spinner fa-spin dark:text-white" style={{ fontSize: '12px' }}></i>
          ) : isVerified ? (
            <i className="fas fa-check text-dark" style={{ fontSize: '14px', fontWeight: 'bold' }}></i>
          ) : null}
        </div>
        <span className="dark:text-white" style={{ fontSize: '14px', fontWeight: '500' }}>
          I'm not a robot
        </span>
      </div>
