            ...
            <div className="col-lg-6">
              <div className="cs-about_left">
                <div className="sec-title--two sec-title--three">
                  ...
                  <p className="content mt-3" style={{ color: 'var(--color-text-muted)', fontSize: '15px', lineHeight: '1.7' }}>
            ...
            <div className="col-lg-6">
              <div className="cs-about_right pos-rel text-center">
                ...
                >
                  ...
                  />
                  <div className="d-flex align-items-center justify-content-center gap-3 p-3" style={{ backgroundColor: 'var(--input-bg)', borderRadius: '14px' }}>
                    <h3 className="text-primary mb-0" style={{ fontWeight: '800', fontSize: '32px' }}>10+</h3>
                    <span className="text-main text-start" style={{ fontSize: '14px', maxWidth: '280px' }}>
