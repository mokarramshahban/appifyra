...
export default function BrandMarquee() {
  ...
  return (
    <section className="brand py-5 overflow-hidden pos-rel bg-white dark:bg-[#060813]" style={{ borderTop: '1px solid var(--input-bg)', borderBottom: '1px solid var(--input-bg)' }}>
