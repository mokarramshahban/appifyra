        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <div className="content">
              ...
              <p>As is common practice with almost all professional websites, this site uses cookies, which are small text files stored on your device, to improve your experience.</p>
