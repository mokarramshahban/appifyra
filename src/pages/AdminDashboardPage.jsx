  ...
  return (
    <div className="pt-140 pb-100 pos-rel">
      <div className="container">
        ...
        >
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                <span className="badge bg-green-100 text-green-900 dark:bg-green-600 dark:text-white mb-1">ADMINISTRATOR CONTROL PANEL</span>
          ...
          <div className="d-flex flex-wrap gap-2 mt-4 pt-3 border-top border-secondary">
            <button 
              ...
              className={`btn btn-glow-hover ${activeTab === 'hero-quick' ? 'bg-blue-100 text-blue-900 border border-blue-200 shadow-sm dark:bg-blue-600 dark:text-white dark:border-none hover:bg-blue-200 dark:hover:bg-blue-700 font-semibold' : 'btn-outline-light'}`}
            ...
            <button 
              ...
              className={`btn btn-glow-hover ${activeTab === 'full-internship' ? 'bg-blue-100 text-blue-900 border border-blue-200 shadow-sm dark:bg-blue-600 dark:text-white dark:border-none hover:bg-blue-200 dark:hover:bg-blue-700 font-semibold' : 'btn-outline-light'}`}
              style={{ borderRadius: '10px', fontSize: '13px', fontWeight: '600' }}
            >
            ...
            <button 
              ...
              className={`btn btn-glow-hover ${activeTab === 'contact-inquiries' ? 'bg-blue-100 text-blue-900 border border-blue-200 shadow-sm dark:bg-blue-600 dark:text-white dark:border-none hover:bg-blue-200 dark:hover:bg-blue-700 font-semibold' : 'btn-outline-light'}`}
              style={{ borderRadius: '10px', fontSize: '13px', fontWeight: '600' }}
            >
            ...
            <button 
              ...
              className={`btn btn-glow-hover ${activeTab === 'subscribers' ? 'bg-blue-100 text-blue-900 border border-blue-200 shadow-sm dark:bg-blue-600 dark:text-white dark:border-none hover:bg-blue-200 dark:hover:bg-blue-700 font-semibold' : 'btn-outline-light'}`}
              style={{ borderRadius: '10px', fontSize: '13px', fontWeight: '600' }}
            >
            ...
            <button 
              ...
              className={`btn btn-glow-hover ${activeTab === 'issue-cert' ? 'bg-green-100 text-green-900 border border-green-200 shadow-sm dark:bg-green-600 dark:text-white dark:border-none hover:bg-green-200 dark:hover:bg-green-700 font-semibold' : 'btn-outline-success'}`}
              style={{ borderRadius: '10px', fontSize: '13px', fontWeight: '600' }}
            >
        ...
        {editingApp && (
          <div className="p-4 mb-4 text-main bg-white border border-slate-200 shadow-sm dark:bg-[#0d1226] dark:border-none" style={{ border: '1px solid var(--input-border)', borderRadius: '16px' }}>
            ...
            <form onSubmit={handleSaveEditApp}>
              <div className="row g-3">
                <div className="col-md-6">
                  ...
                  <input type="text" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={appEditForm.fullName} onChange={(e) => setAppEditForm({ ...appEditForm, fullName: e.target.value })} required />
                </div>
                <div className="col-md-6">
                  <label className="form-label text-muted">Email Address</label>
                  <input type="email" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={appEditForm.email} onChange={(e) => setAppEditForm({ ...appEditForm, email: e.target.value })} required />
                </div>
                ...
                <div className="col-md-4">
                  ...
                  <input type="text" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={appEditForm.domain} onChange={(e) => setAppEditForm({ ...appEditForm, domain: e.target.value })} required />
                </div>
                <div className="col-md-4">
                ...
                <div className="col-12 mt-3 d-flex gap-2">
                  <button 
                    ...
                    className="btn bg-green-100 text-green-900 border border-green-200 shadow-sm dark:bg-green-600 dark:text-white dark:border-none hover:bg-green-200 dark:hover:bg-green-700 font-semibold px-4 py-2 font-weight-bold"
            ...
            <form onSubmit={handleSaveEditInq}>
              <div className="row g-3">
                <div className="col-md-6">
                  ...
                  <input type="text" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={inqEditForm.fullName} onChange={(e) => setInqEditForm({ ...inqEditForm, fullName: e.target.value })} required />
                </div>
                <div className="col-md-6">
                  <label className="form-label text-muted">Sender Email</label>
                  <input type="email" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={inqEditForm.email} onChange={(e) => setInqEditForm({ ...inqEditForm, email: e.target.value })} required />
                </div>
                <div className="col-12">
                  <label className="form-label text-muted">Subject / Topic</label>
                  <input type="text" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={inqEditForm.subject} onChange={(e) => setInqEditForm({ ...inqEditForm, subject: e.target.value })} required />
                </div>
                <div className="col-12">
                  <label className="form-label text-muted">Message Body</label>
                  <textarea rows="3" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={inqEditForm.message} onChange={(e) => setInqEditForm({ ...inqEditForm, message: e.target.value })} required></textarea>
                </div>
                <div className="col-12 mt-3 d-flex gap-2">
                  <button 
                    type="submit" 
            ...
            <form onSubmit={handleSaveEditSub}>
              <div className="row g-3">
                <div className="col-md-8">
                  <label className="form-label text-muted">Email Address</label>
                  <input type="email" className="form-control text-main" style={{ backgroundColor: 'var(--input-bg)' }} value={subEditEmail} onChange={(e) => setSubEditEmail(e.target.value)} required />
                </div>
        ...
        {activeTab === 'hero-quick' && (
          <div>
            <div className="d-flex align-items-center justify-content-between mb-4">
              ...
              <span className="badge bg-blue-100 text-blue-900 dark:bg-blue-600 dark:text-white px-3 py-2" style={{ fontSize: '14px' }}>Total: {heroQuickApps.length}</span>
            </div>

            {loading ? (
              <TableSkeleton rows={5} cols={6} />
            ) : heroQuickApps.length === 0 ? (
              <div className="p-5 text-center text-main" style={{ backgroundColor: 'var(--input-bg)', borderRadius: '16px' }}>
                  ...
                  <tbody>
                    {heroQuickApps.map(app => (
                      <tr key={app.id} className={updatingId === app.id ? 'row-status-updating' : ''}>
                        ...
                        <td><span className="badge bg-slate-100 text-slate-900 dark:bg-slate-600 dark:text-white">{app.duration}</span></td>
                        <td style={{ color: 'var(--color-primary-light)', fontWeight: '600' }}>{app.domain}</td>
                        <td>
                          <span className={`badge status-badge-anim ${app.status === 'Approved' ? 'bg-green-100 text-green-900 dark:bg-green-600 dark:text-white' : app.status === 'Completed' ? 'bg-cyan-100 text-cyan-900 dark:bg-cyan-500 dark:text-white' : app.status === 'Rejected' ? 'bg-red-100 text-red-900 dark:bg-red-600 dark:text-white' : 'bg-orange-100 text-orange-900 dark:bg-orange-500 dark:text-white'}`}>
        ...
        {activeTab === 'full-internship' && (
          <div>
            <div className="d-flex align-items-center justify-content-between mb-4">
              ...
              <span className="badge bg-blue-100 text-blue-900 dark:bg-blue-600 dark:text-white px-3 py-2" style={{ fontSize: '14px' }}>Total: {fullInternshipApps.length}</span>
            </div>
                  ...
                  <tbody>
                    {fullInternshipApps.map(app => (
                      <tr key={app.id} className={updatingId === app.id ? 'row-status-updating' : ''}>
                        ...
                        <td>
                          <span className="badge bg-slate-100 text-slate-900 dark:bg-slate-600 dark:text-white me-1">{app.duration}</span>
        ...
        {activeTab === 'contact-inquiries' && (
          <div>
            <div className="d-flex align-items-center justify-content-between mb-4">
              ...
              <span className="badge bg-blue-100 text-blue-900 dark:bg-blue-600 dark:text-white px-3 py-2" style={{ fontSize: '14px' }}>Total: {inquiries.length}</span>
            </div>
        ...
        {activeTab === 'subscribers' && (
          <div>
            <div className="d-flex align-items-center justify-content-between mb-4">
              ...
              <span className="badge bg-blue-100 text-blue-900 dark:bg-blue-600 dark:text-white px-3 py-2" style={{ fontSize: '14px' }}>Total Subscribers: {subscribers.length}</span>
            </div>

            {/* Broadcast Newsletter Composer Box */}
            <div className="p-4 mb-4 text-main bg-white border border-slate-200 shadow-sm dark:bg-[#0d1226] dark:border-none" style={{ border: '1px solid var(--input-border)', borderRadius: '20px' }}>
              <div className="d-flex align-items-center justify-content-between mb-3">
                ...
                <span className="badge bg-green-100 text-green-900 dark:bg-green-600 dark:text-white" style={{ fontSize: '12px' }}>
        ...
        {activeTab === 'issued-certs' && (
          <div>
            <div className="d-flex align-items-center justify-content-between mb-4">
              ...
              <span className="badge bg-cyan-100 text-cyan-900 dark:bg-cyan-500 dark:text-white px-3 py-2" style={{ fontSize: '14px', fontWeight: '700' }}>Total: {issuedCerts.length}</span>
            </div>
                  ...
                  <tbody>
                    {issuedCerts.map((cert, idx) => (
                      <tr key={cert.id || cert.certificateId || idx}>
                        ...
                        <td><span className="badge bg-blue-100 text-blue-900 dark:bg-blue-600 dark:text-white">{cert.performanceGrade || cert.grade || 'Excellence (A+)'}</span></td>
            ...
            <div className="col-lg-8">
              ...
              >
                <div className="d-flex align-items-center justify-content-between mb-4 pb-3" style={{ borderBottom: '1px solid var(--card-border)' }}>
                  <div>
                    <span className="badge bg-green-100 text-green-900 dark:bg-green-600 dark:text-white mb-1">OFFICIAL ISSUANCE TOOL</span>
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col-12 mt-4">
                        <button 
                          type="submit" 
                          disabled={isIssuing}
                          className="btn bg-green-100 text-green-900 border border-green-200 shadow-sm dark:bg-green-600 dark:text-white dark:border-none hover:bg-green-200 dark:hover:bg-green-700 font-semibold btn-lg w-100"
